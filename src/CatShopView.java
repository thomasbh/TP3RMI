...
class CatShopView {
    ...
    private Button botonActualizarMisVentas;

    //boton actualizar Compra de Producto
    private Button botonActualizarComprarProducto;

    //boton actualizar Mis comprasen curso
    private Button botonActualizarComprasEnCurso;

    //boton actualizar Compras Acabadas
    private Button botonActualizarComprasAcabadas;

    //boton actualizar Extra
    private Button botonActualizarExtra;
