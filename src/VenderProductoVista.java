...
public class VenderProductoVista extends JFrame  {
    ...
    public VenderProductoVista(){
        ...
        areaTiempoLimite.setBounds(300, 110, 200, 20);
        ...
        etiquetaTiempoimite = new JLabel("Tiempo Límite:");
        ...
        etiquetaTiempoimite.setBounds(100, 110, 200, 20);
        ...
        venderProductos.add(etiquetaTiempoimite);
